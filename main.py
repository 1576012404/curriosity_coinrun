...
from wrappers import MontezumaInfoWrapper, make_mario_env, make_robo_pong, make_robo_hockey, \
    make_multi_pong, AddRandomStateToInfo, MaxAndSkipEnv, ProcessFrame84, ExtraTimeLimit,make_coinrun


def start_experiment(**args):
    make_env = make_env_all_params(0,add_monitor=False,args=args)
...
class Trainer(object):
    def __init__(self, make_env, hps, num_timesteps, envs_per_process):
        ...
        print("make_env",make_env)
        self.hps = hps
        self.envs_per_process = envs_per_process
        self.num_timesteps = num_timesteps
        self._set_env_vars()
        self.ob_space=make_env.observation_space
        self.ac_space=make_env.action_space
        print("obs_space",self.ob_space)
...
def add_rollout_params(parser):
    parser.add_argument('--nsteps_per_seg', type=int, default=256)
